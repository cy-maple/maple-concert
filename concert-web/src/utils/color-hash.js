...
let blocks = [];
let Sha256 = /** @class */ (function () {
  function Sha256(is224, sharedMemory) {
    if (is224 === void 0) {
      is224 = false;
    }
    if (sharedMemory === void 0) {
      sharedMemory = false;
    }
    ...
    __classPrivateFieldSet(
      ...
      __classPrivateFieldSet(
        ...
        __classPrivateFieldSet(
          this,
          _bytes,
          __classPrivateFieldSet(this, _hBytes, 0)
        )
      )
    );
    __classPrivateFieldSet(
  ...
  Sha256.prototype.update = function (message) {
    ...
    let blocks = __classPrivateFieldGet(this, _blocks);
    while (index < length) {
      let i = void 0;
      ...
      if (typeof msg !== "string") {
        for (
          i = __classPrivateFieldGet(this, _start);
          index < length && i < 64;
          ++index
        ) {
      ...
      __classPrivateFieldSet(
        this,
        _bytes,
        __classPrivateFieldGet(this, _bytes) +
          (i - __classPrivateFieldGet(this, _start))
      );
      if (i >= 64) {
    ...
    if (__classPrivateFieldGet(this, _bytes) > 4294967295) {
      __classPrivateFieldSet(
        this,
        _hBytes,
        __classPrivateFieldGet(this, _hBytes) +
          ((__classPrivateFieldGet(this, _bytes) / 4294967296) << 0)
      );
      __classPrivateFieldSet(
        this,
        _bytes,
        __classPrivateFieldGet(this, _bytes) % 4294967296
      );
    }
    return this;
  };
  Sha256.prototype.finalize = function () {
    ...
    let blocks = __classPrivateFieldGet(this, _blocks);
    let i = __classPrivateFieldGet(this, _lastByteIndex);
    ...
    blocks[14] =
      (__classPrivateFieldGet(this, _hBytes) << 3) |
      (__classPrivateFieldGet(this, _bytes) >>> 29);
  ...
  Sha256.prototype.hash = function () {
    ...
    __classPrivateFieldSet(
      this,
      _h0,
      (__classPrivateFieldGet(this, _h0) + a) << 0
    );
    __classPrivateFieldSet(
      this,
      _h1,
      (__classPrivateFieldGet(this, _h1) + b) << 0
    );
    __classPrivateFieldSet(
      this,
      _h2,
      (__classPrivateFieldGet(this, _h2) + c) << 0
    );
    __classPrivateFieldSet(
      this,
      _h3,
      (__classPrivateFieldGet(this, _h3) + d) << 0
    );
    __classPrivateFieldSet(
      this,
      _h4,
      (__classPrivateFieldGet(this, _h4) + e) << 0
    );
    __classPrivateFieldSet(
      this,
      _h5,
      (__classPrivateFieldGet(this, _h5) + f) << 0
    );
    __classPrivateFieldSet(
      this,
      _h6,
      (__classPrivateFieldGet(this, _h6) + g) << 0
    );
    __classPrivateFieldSet(
      this,
      _h7,
      (__classPrivateFieldGet(this, _h7) + h) << 0
    );
  };
  Sha256.prototype.hex = function () {
    this.finalize();
    let h0 = __classPrivateFieldGet(this, _h0);
    let h1 = __classPrivateFieldGet(this, _h1);
    let h2 = __classPrivateFieldGet(this, _h2);
    let h3 = __classPrivateFieldGet(this, _h3);
    let h4 = __classPrivateFieldGet(this, _h4);
    let h5 = __classPrivateFieldGet(this, _h5);
    let h6 = __classPrivateFieldGet(this, _h6);
    let h7 = __classPrivateFieldGet(this, _h7);
    let hex =
  ...
  Sha256.prototype.arrayBuffer = function () {
    ...
    let buffer = new ArrayBuffer(
      __classPrivateFieldGet(this, _is224) ? 28 : 32
    );
...
let ColorHash = /** @class */ (function () {
  function ColorHash(options) {
    if (options === void 0) {
      options = {};
    }
    let _a = [options.lightness, options.saturation].map(function (param) {
